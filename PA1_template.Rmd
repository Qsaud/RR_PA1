...
```
and we can see that there is no impact of replacing the NA's on the the mean nor the median.
...
```
### Plotting the comparison using _lattice_ graphical system.
```{r}
